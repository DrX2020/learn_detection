    ...
    def evaluate(self,
        ...
        if metric == 'mAP':
            ...
            for iou_thr in iou_thrs:
                ...
                mean_ap, final_results, ave_acc = eval_map(
                    results,
                    annotations,
                    scale_ranges=scale_ranges,
                    iou_thr=iou_thr,
                ...
                eval_results[f'aver_dacc'] = round((recall*precision/recall+precision-recall*precision+1e-6), 4)
                eval_results[f'ave_acc'] = round(ave_acc, 4)

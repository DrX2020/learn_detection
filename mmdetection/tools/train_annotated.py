...
def main():
    ...
    # read contents from file or codes in command and load them into cfg
    # args is in command level(api level) and cfg is in code level
    # it is necessary to pass information from command level to code level
    ...
    if args.work_dir is not None:
        ...
        # use config filename as default work_dir if cfg.work_dir is None, osp is the abbreviation of module os.path
    ...
    # create work_dir, osp.abspath(cfg.work_dir) returns the absolute path of cfg.work_dir
